...
class CltValideController extends Controller
{
    /**
    ...
    {
        //$this->gestVarSession();
        $clients = CidClient::where('valide',0)->get();

        return view('/pages.cltvalide',compact('clients'));
    ...
    public function edit($id)
    {
       ...
       // dd($client->client);
        ...
        return view ('pages.createCltvalide',([
            'client'=>$client,
            'quartiers'=>CidQuartier::all(),
            'activites'=>CidActivite::all(),
    ...
    public function update(Request $request, $id)
    {
       ...
       // dd( $client);
        ...
        if($client)
        {
            ...
            $clientAdd = [
                ...
                if ($client->update($clientAdd))
                {
                    ...
                    Toastr::success('Validation effectuée avec succès');
                }
                else{

                    session(['update_msg'=>'OUI']);
                    Toastr::error('Echec de validation du client');
                 //   dd('ici');
                }
        ...
        return redirect()->route('cltvalide',([
