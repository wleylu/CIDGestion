            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <div lass="align-middle inline-block min-w-full shadow
                    ...
                    <div class="alert-danger text text-2xl text-center  text-bold text-primary">
                        LISTE DES TYPES DE COMPTES PARAMETRES
                    </div>
                    ...
                    <div class="right-10 col-md-1 py-2">
                        <a href="{{ route('typecpt.create') }}"  class="text-white bg-orange-700 hover:bg-indigo-500 focus:ring-4
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                         ...
                         <table id="example" class=" py-1 table table-striped table-bordered table-responsive" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($typecpts as $typecpt)
                                        <tr>
                                            <td>{{ $typecpt ->code }}</td>
                                            <td>{{ $typecpt ->libelle }}</td>
                                            <td>{{ $typecpt ->classe }}</td>
                                            <td>
                                                <a type="button" href="{{ route('typecpt.edit',['id'=>$typecpt->id]) }}" class="text-primary px-2" >
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <a type="button" href="{{ route('typecpt.delete',['id'=>$typecpt->id]) }}" class="text-danger">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
