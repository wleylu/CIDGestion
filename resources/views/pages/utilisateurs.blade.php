...
<div class="py-3">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <div class="right-4 col-md-1 py-1">
                <a href="{{ route('register') }}" class="text-white bg-orange-700 hover:bg-indigo-500 focus:ring-4
                focus:ring-blue-300 font-medium text-sm  text-center
                flex items-center justify-center flex-1 h-full  rounded-lg px-2">
                <svg xmlns="http://www.w3.org/2000/svg"  class="h-6 w-4" fill="none" viewBox="0 0 20 20" stroke="currentColor">
                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td width="100px">
                                    ...
                                    <a type="button" href="#" class="text-primary px-1" >
