            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <div lass="align-middle inline-block min-w-full shadow
                    ...
                    <div class="alert-danger text text-2xl text-center  text-bold text-primary">
                        LISTE DES PERIODES PARAMETRES
                    </div>

                    <div class="right-10 col-md-1 py-2">
                        <a href="{{ route('periode.create') }}"  class="text-white bg-orange-700 hover:bg-indigo-500 focus:ring-4
                         ...
                         <table id="example" class=" py-1 table table-striped table-bordered table-responsive" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($periodes as $periode)
                                        <tr>
                                            <td>{{ $periode ->codeCom }}</td>
                                            <td>{{ $periode ->libelle }}</td>
                                            <td width="10%">
                                                <a type="button" href="{{ route('periode.edit',['id'=>$periode->id]) }}" class="text-primary px-2" >
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <a type="button" href="{{ route('periode.delete',['id'=>$periode->id]) }}" class="text-danger">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
