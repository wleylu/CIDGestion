            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <div lass="align-middle inline-block min-w-full shadow
                    ...
                    <div class="alert-danger text text-2xl text-center  text-bold text-primary">
                        LISTE DES COMMISSIONS PARAMETRES
                    </div>

                    <div class="right-10 col-md-1 py-2">
                        <a href="{{ route('commission.create') }}"  class="text-white bg-orange-700 hover:bg-indigo-500 focus:ring-4
                                ...
                                <tbody>
                                    @foreach ($commissions as $com)
                                        <tr>
                                            ...
                                            <td>{{ $com ->compte }}</td>
                                            <td>{{ $com->taux }}</td>
                                            <td>{{ $com->cid_periode->libelle }}</td>
                                            <td>{{ $com->mnt }}</td>
                                            <td>


                                                <a type="button" href="{{ route('commission.edit',['id'=>$com->id]) }}" class="text-primary px-2" >
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <a type="button" href="{{ route('commission.delete',['id'=>$com->id]) }}" class="text-danger">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
